...
%In general, coverage information is not available in existing datasets
...
%Our results show that coverage information in this case is useful to assign priorities to
%the training dataset of the ranking algorithms. They also show that for the pipeline under
%study, we can reduce the amount of tests run by 60\%, which in average corresponds to
%a 90\% improvement in test execution time. We also discuss some of the possible threats 
%to validity of these results, along with proposals on how this approach could be used in
